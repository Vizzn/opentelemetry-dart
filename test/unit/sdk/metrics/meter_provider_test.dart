...
void main() {
  group('MeterProvider:', () {
    ...
    test(
      'getting meters by different names will return different instances',
      () {
    ...
    test(
      ...
      () {
        ...
        final meterProvider = sdk.MeterProvider(resource: sdk.Resource([]));
        final meterA = meterProvider.get(
          meterName,
          version: version,
          schemaUrl: url,
        );
        final meterB = meterProvider.get(
          meterName,
          version: version,
          schemaUrl: url,
        );
    ...
    test('getting by same name, same version, same schema_url and different '
