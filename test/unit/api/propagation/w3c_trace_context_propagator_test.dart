...
void main() {
  test('extract trace context', () {
    ...
    expect(
      resultSpan.spanContext.traceFlags & api.TraceFlags.sampled,
  ...
  test('inject trace parent', () {
    ...
    api.W3CTraceContextPropagator().inject(
      testContext,
      testCarrier,
      TestingInjector(),
    );
